		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Module One",
									"targetURL": "#comasintrndswmodule1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comasintrndswmodule1-display": {
								"semanticObject": "comasintrndswmodule1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.asint.rnd.sw.module1",
									"url": sap.ui.require.toUrl("com/asint/rnd/sw/module1")
								}
							}
						}
					}
